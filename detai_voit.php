        ...
        <section id="content_wrapper">
            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                       ...
                       <li class="crumb-link">Consulter mes voitures</li>
            ...
            <div id="content">
                                                        ...
                                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                                            ...
                                                            <div class="tab-body">
                                                                <div class="fileupload-preview thumbnail">
                                                                    <img src="img_voiture/<?php echo $email_utilisateur.".png"; ?>" alt="voiture" style="margin-top: 5px;" width="190" height="200">
                                ...
                                <div class="panel-body pn">
                                    <table class="table">
										...
										<tbody>
                                            ...
                                            <tr>
                                                <td>Modele</td>
                                                <td><?php echo $enreg['modele']?></td>
                                            </tr>
                                       
                                            <tr>
                                                <th>Matricule</th>
                                                <th><?php echo $enreg['num_immat']?></th>
                                            </tr>
                                        
                                            <tr>
                                                <td>Couleur</td>
                                                <td><?php echo $enreg['couleur']?></td>
                                            </tr>
                                        
                                            <tr>
                                                <th>Energie</th>
                                                <th><?php echo $enreg['energie']?></th>
                                            </tr>
                                       
                                            <tr>
                                                <td>Puissance</td>
                                                <td><?php echo $enreg['puissance']?></td>
                                            </tr>
                                        
                                            <tr>
                                                <th>Vidange : Dernier changement</th>
                                                <th><?php echo $enreg['vidange_dernier']?></th>
                                            </tr>
                                       
                                            <tr>
                                                <td>Vidange : Prochaine changement</td>
                                                <td><?php echo $enreg['vidange_prochaine']?></td>
                                            </tr>
                                       
                                            <tr>
                                                <th>Visite technique : Numéro document</th>
                                                <th><?php echo $enreg['num_visite']?></th>
                                            </tr>
                                        
                                            <tr>
                                                <td>Visite technique : Date début</td>
                                                <td><?php echo $enreg['visite_debut']?></td>
                                            </tr>
                                        
                                            <tr>
                                                <th>Visite technique : Date fin</th>
                                                <th><?php echo $enreg['visite_fin']?></th>
                                            </tr>
                                        
                                            <tr>
                                                <td>Prix par jour</td>
                                                <td><?php echo $enreg['prix_jour']?></td>
                                            </tr>
                                        </tbody>
				...
				?><br>
										...
										<a href="consu_voiture.php" class="btn btn-rounded btn-dark btn-block"  >Retour</a>
