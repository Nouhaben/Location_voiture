            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Consulter mes chauffeurs</li>
            ...
            <div id="content">
                                ...
                                <div class="panel-body pn">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>CIN N°</td>
                                                <td><?php echo $enreg['num_cin']?></td>
                                            </tr>
                                        </tbody>
										<thead>
                                            <tr>
                                                <th><Nationalité/th>
                                                <th><?php echo $enreg['nationalite']?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>Permis de conduite N°</td>
                                                <td><?php echo $enreg['num_permis']?></td>
                                            </tr>
                                        </tbody>
										<thead>
                                            <tr>
                                                <th>Délivrée le</th>
                                                <th><?php echo $enreg['date_delivre']?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
										...
										<thead>
                                            <tr>
                                                ...
                                                <th><?php echo $enreg['situation_fami']?></th>
                                            </tr>
                                        </thead>
				...
				?>
                    <div class="text-right">
										<a href="consu_chauffeurs.php" class="btn btn-rounded btn-dark btn-block"  >Retour</a>
