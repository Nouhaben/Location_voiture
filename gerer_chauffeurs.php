    ...
    <div id="main">
        ...
        <section id="content_wrapper">
			...
			<script language="javascript">
								  ...
								  {
									var confirmation = confirm( "Voulez vous vraiment supprimer ce chauffeur ?" ) ;
								if( confirmation )
								{
								  document.location.href = "supp_chauffs.php?id_chauffeur="+id ;
								}
								  }
							</script>
            ...
            <div id="content">
				...
				<h4 class="lh30 mt15 text-center">Gérer mes chauffeurs</b></h4>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<tr >"; 
													echo"<td>".$enreg['nom_pren']."<b></td>";
													echo"<td>".$enreg['num_cin']."<b></td>";
													echo"<td>".$enreg['num_permis']."<b></td>";
													echo"<td><a href='modif_chauff.php?id=".$enreg[0]."' class=\"btn btn-rounded btn-success btn-block \"  >Modifier</a></td>"; 
