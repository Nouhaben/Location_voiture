    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <div id="content">
				...
				<h4 class="lh30 mt15 text-center">Consulter chauffeurs</b></h4>
                                    ...
                                    <tbody>
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<tr >"; 
													...
													echo"<td>".$enreg['telephone']."<b></td>";
													echo"<td><a href='detai_chauff.php?id=".$enreg[0]."' class=\"btn btn-rounded btn-success btn-block\"  >Consulter</a></td>"; 
												echo"</tr>";	
												}
										?>
