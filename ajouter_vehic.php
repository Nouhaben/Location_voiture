...
if ( isset($_POST['ok']) ) {
	...
	$sql = "INSERT INTO louer_voiture(id_client,id_voiture,lieu_livr_retour,date_depart,heure_depart,date_retour,heure_retour,date_retour_reele,dure_location,assurance,poste_radio,roue_secours,cric,document,siege_bb,carburant_depart,carburant_retour,kilom_depart,kilom_retour,etat_vehicule) 
	VALUES('$id_client','$id_voiture','$lieu_livr_retour','$date_depart','$heure_depart','$date_retour','$heure_retour','$date_retour_reele','$dure_location','$assurance','$poste_radio','$roue_secours','$cric','$document','$siege_bb','$carburant_depart','$carburant_retour','$kilom_depart','$kilom_retour','$etat_vehicule')";
	$requete = mysql_query($sql) or die( mysql_error() ) ;
 
  if($requete)
  {
    
	echo '<script type="text/javascript">alert("Vous ajout est bien effectuer");</script>';
	echo '<script type="text/javascript">window.location.href="consu_louer.php";</script>';
    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <section id="content">
				...
				<h4 class="lh30 mt15 text-center">Louer voiture</b></h4>
                                ...
                                <form method="post" action="" id="admin-form">
									...
									<div class="section">
										...
										<center><label for="username" class="field-label">Client ou raison social</label></center>
                                            ...
                                            <center><label for="username" class="field-label">Voiture</label></center>
                                                 <label class="field select">
													...
													{
															echo '<option value="'.$rw['id_voiture'].'" >'.$rw['marque'].'&nbsp'.$rw['modele'].'&nbsp'.$rw['num_immat'].'</option>';
														}
															echo '</select>';
                                       ...
                                       <div class="section">
										<label for="username" class="field-label">Lieu de livraison et de retour</label>	
                                            <label for="website" class="field prepend-icon">
                                                <input type="text" name="lieu_livr_retour" id="website" class="gui-input" placeholder="Lieu de livraison et de retour">
                                            ...
                                            <div class="col-md-6">
                                                <div class="section">
                                                    ...
                                                    <label class="field prepend-icon">
                                                        <input  name="date_depart" id="firstname" class="gui-input" value="<?php echo date('Y/m/d'); ?>" >
                                            ...
                                            <div class="col-md-6">
												...
												<label for="username" class="field-label">Heure de Départ</label>
                                                    <label class="field append-icon">
                                                        <input  name="heure_depart" id="firstname" class="gui-input" value="<?php echo date('H:i'); ?>" >
                                                        <label for="firstname" class="field-icon">
                                                        </label>
                                                    </label>
                                                </div>
										...
										<div class="row">
                                            <div class="col-md-6">
                                                <div class="section">
                                                    ...
                                                    <label class="field prepend-icon">
                                                        <input  name="date_retour" id="firstname" class="gui-input" value="<?php echo date('Y/m/d'); ?>" >
                                                        <label for="firstname" class="field-icon">
                                                        </label>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-md-6">
												...
												<label for="username" class="field-label">Heure de Retour</label>
                                                    <label class="field append-icon">
                                                        <input  name="heure_retour" id="firstname" class="gui-input" value="<?php echo date('H:i'); ?>" >
                                                        <label for="firstname" class="field-icon">
                                                        </label>
                                                    </label>
                                                </div>
										...
										<label for="username" class="field-label">Date de retour réelle</label>
                                             <label for="datetimepicker3" class="field prepend-icon">
                                                    <input type="date"  name="date_retour_reele" class="gui-input" placeholder="Date de retour réelle">
										...
										<label for="username" class="field-label">Durée de Location</label>
                                                <label for="firstname" class="field prepend-icon">
                                                    <input type="text" name="dure_location" id="firstname" class="gui-input" placeholder="Durée de Location">
                                                    <label class="field-icon"> </label>  
                                                </label>
                                            
                                        </div><br><!-- end .section row section -->  
                                       ...
                                       <div class="section-divider mv40 mt20"><span> EQUIPEMENTS ET ACCESSOIRES  </span></div><!-- .section-divider -->                                         
											...
											<div class="section">
											<div class="section"><label for="username" class="field-label">Roue de secours :</label>
												<label class="field select">
											...
											<div class="section">
											<div class="section"><label for="username" class="field-label">Cric :</label>
												<label class="field select">
											...
											<div class="section">
											<div class="section"><label for="username" class="field-label">Documents :</label>
												<label class="field select">
											...
											<div class="section">
											<div class="section"><label for="username" class="field-label">Siège bébé :</label>
												<label class="field select">
										...
										<div class="row">
                                                ...
                                                <div class="section">
													<label for="username" class="field-label">Kilométrage - Départ :</label>
														<label for="username" class="field prepend-icon">
															<input type="text" name="kilom_depart" id="username" class="gui-input" placeholder="Kilométrage - Départ">
                                            ...
                                            <div class="col-md-6">
												...
												<label for="username" class="field-label">Kilométrage - Retour :</label>
                                                    <label for="firstname" class="field prepend-icon">
														<input type="text" name="kilom_retour" id="firstname" class="gui-input" placeholder="Kilométrage - Retour">
														<label for="firstname" class="field-icon"></label>  
													</label> 
                                                </div>
                                            </div>
                                       ...
                                       <div class="section-divider mv40"><span>  ETAT DU VEHICULE </span></div><!-- .section-divider --> 
										...
										<div class="section">
                                            <label for="comment" class="field prepend-icon">
                                                <textarea class="gui-textarea" id="comment" name="etat_vehicule" placeholder="Etat de vehicule"></textarea>
                                    ...
                                    <div class="panel-footer text-right">
                                        <button type="submit" name="ok" class="button btn-primary"> Louer </button>
