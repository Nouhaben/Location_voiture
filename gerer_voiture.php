    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Gérer mes voiture</li>
                    </ol>
                </div>
			...
			<script language="javascript">
								  ...
								  {
									var confirmation = confirm( "Voulez vous vraiment supprimer cette voiture ?" ) ;
								if( confirmation )
								{
								  document.location.href = "supp_voiture.php?id_voiture="+id ;
								}
								  }
								</script>
            <div id="content">
				...
				<h4 class="lh30 mt15 text-center">Gérer mes voitures</b></h4>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable2" cellspacing="0" width="100%">
									...
									<?php
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<tr >"; 
													echo"<td>".$enreg['marque'].'&nbsp'.$enreg['modele']."<b></td>";
													echo"<td>".$enreg['num_immat']."<b></td>";
													echo"<td>".$enreg['prix_jour']."<b></td>";
													echo"<td><a href='modif_voiture.php?id_voiture=".$enreg[0]."' class=\"btn btn-rounded btn-success btn-block \"  >Modifier</a></td>"; 
