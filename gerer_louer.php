    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <div id="content">
				...
				<h4 class="lh30 mt15 text-center">Gérer mes Vehicules</b></h4>
                ...
                <div class="row">
							...
							<script language="javascript">
								...
								if( confirmation )
								{
								  document.location.href = "supp_location.php?id_location="+id ;
								}
								  }
							</script>
                    <div class="col-md-12">
                            ...
                            <div class="panel-body pn">
                                <table class="table table-striped table-bordered table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
										...
										$query ="SELECT * FROM louer_voiture ";
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<tr >"; 
													...
													echo $dat['nom_rais_cli'] ;
												
												echo"</td>";
													echo"<td>".$enreg['dure_location']."<b></td>";
													echo"<td>";
														
														$req=mysql_query("SELECT prix_jour FROM voiture  where  id_voiture='".$enreg['id_voiture']."'");
													...
													echo"</td>";
													echo"<td><a href='modif_louer.php?id=".$enreg[0]."' class=\"btn btn-rounded btn-success btn-block \"  >Modifier</a></td>"; 
													echo"<td><a href= \"#\" class=\"btn btn-rounded btn-danger btn-block\"  onClick=\"confirme(".$enreg[0].")\" >Supprimer</a></td>"; 
												echo"</tr>";	
												}
										?>
