        ...
        <section id="content_wrapper">
            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Gérer mes clients</li>
                    </ol>
                </div>
            ...
            <!-- End: Topbar -->
							<script language="javascript">
								...
								if( confirmation )
								{
								  document.location.href = "supp_client.php?id_client="+id ;
								}
								  }
							</script>
            <div id="content">
				...
				<h4 class="lh30 mt15 text-center">Gérer mes clients</b></h4>
                                    ...
                                    <tbody>
                                       <?php
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<tr >"; 
													echo"<td>".$enreg['nom_rais_cli']."<b></td>";
													echo"<td>".$enreg['cin_cli']."<b></td>";
													echo"<td>".$enreg['num_permis_cli']."<b></td>";
													echo"<td><a href='modif_client.php?id=".$enreg[0]."' class=\"btn btn-rounded btn-success btn-block \"  >Modifier</a></td>"; 
