...
include "config.php";
	...
	$sql = "INSERT INTO chauffeur(nom_pren,adresse,email,num_cin,nationalite,num_permis,date_delivre,telephone,situation_fami) 
	VALUES('$nom_pren','$adresse','$email','$num_cin','$nationalite','$num_permis','$date_delivre','$telephone','$situation_fami')";
	$requete = mysql_query($sql) or die( mysql_error() ) ;
 
  if($requete)
  {
    
	echo '<script type="text/javascript">alert("Vous avez bien ajouter le chauffeur");</script>';
	echo '<script type="text/javascript">window.location.href="consu_chauffeurs.php";</script>';
            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Ajouter chauffeur</li>
                    </ol>
                </div>
                            ...
                            <div class="panel">
                                ...
                                <form method="post" action="" id="admin-form">
                                    <div class="panel-body">
                                        ...
                                        <div class="section">
                                                <label for="firstname" class="field prepend-icon">
                                                    <input type="text" name="nom_pren" id="firstname" class="gui-input" placeholder="Nom et Prénom">
										...
										<div class="section">
                                            <label for="useremail" class="field prepend-icon">
                                                <input type="text" name="adresse" id="useremail" class="gui-input" placeholder="Adresse">
										...
										<div class="section">
                                            <label for="useremail" class="field prepend-icon">
                                                <input type="email" name="email" id="useremail" class="gui-input" placeholder="Email ">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="text" name="num_cin" id="website" class="gui-input" placeholder="CIN N°">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="texte" name="nationalite" id="website" class="gui-input" placeholder="Nationalité">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="texte" name="num_permis" id="website" class="gui-input" placeholder="Permis de conduite N°">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="date" name="date_delivre" id="website" class="gui-input" placeholder="Délivrée le ">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="texte" name="telephone" id="website" class="gui-input" placeholder="Téléphone">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="texte" name="situation_fami" id="website" class="gui-input" placeholder="Situation familiale">
                                                <label for="website" class="field-icon"><i class="fa fa-email"></i></label>  
                                            </label>
                                        </div><!-- end section --> 
                                    ...
                                    <div class="panel-footer text-right">
                                        <button type="submit" class="button btn-primary"> Ajouter chauffeur </button>
