    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Consulter mes voiture</li>
                    </ol>
                </div>
            ...
            <div id="content">
				...
				<h4 class="lh30 mt15 text-center">Consulter voitures</b></h4>
									...
									<?php
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<tr >"; 
													...
													echo"<td>".$enreg['marque']."<b></td>";
													echo"<td>".$enreg['modele']."<b></td>";
													echo"<td>".$enreg['num_immat']."<b></td>";
													echo"<td>".$enreg['prix_jour']."<b></td>";
													echo"<td><a href='detai_voit.php?id_voiture=".$enreg[0]."' class=\"btn btn-rounded btn-success btn-block\"  >Consulter</a></td>"; 
												echo"</tr >"; 	
												}
										?>
