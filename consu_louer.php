    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <div id="content">
				...
				<h4 class="lh30 mt15 text-center">Consulter Vehicules</b></h4>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"</td>";
													echo"<td>".$enreg['date_depart']."<b></td>";
													echo"<td>".$enreg['date_retour']."<b></td>";
													echo"<td>".$enreg['dure_location']."<b></td>";
													echo"<td>";
														
														$req=mysql_query("SELECT * FROM voiture  where  id_voiture='".$enreg['id_voiture']."'");
														$row2 = mysql_fetch_array($req);
														
														
													   $res=$enreg['dure_location'] * $row2['prix_jour']."<br>";
													...
													echo"<td><a href='detai_louer.php?id=".$enreg[0]."' class=\"btn btn-rounded btn-success btn-block\"  >Consulter</a></td>"; 
												echo"</tr>";	
												}
										?>
