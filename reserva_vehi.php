    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <div id="content">
				...
				<h4 class="lh30 mt15 text-center">Consulter les réservation</b></h4>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<tr >"; 
													echo"<td>".$enreg['nom']."<b></td>";
													echo"<td>".$enreg['tel']."<b></td>";
													echo"<td>".$enreg['date_depart'].'&nbsp'.$enreg['heure_depart']."<b></td>";
													echo"<td><a href='detai_rese.php?id=".$enreg[0]."' class=\"btn btn-rounded btn-success btn-block\"  >Consulter</a></td>"; 
												echo"</tr>";	
												}
										?>
