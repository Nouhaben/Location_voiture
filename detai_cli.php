            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Consulter mes clients</li>
            ...
            <div id="content">
                            ...
                            <div class="panel">
                                <div class="panel-body pn">
                                    <table class="table">
                                        <thead>
                                            <tr class="system">
                                                <th>Nom et Prénom ou Raison social</th>
                                                <th><?php echo $enreg['nom_rais_cli']?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
										...
										<thead>
                                            <tr>
                                                <th>Email</th>
                                                <th><?php echo $enreg['email_cli']?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>Profession</td>
                                                <td><?php echo $enreg['profession_cli']?></td>
                                            </tr>
                                        </tbody>
										<thead>
                                            <tr>
                                                <th>CIN N°</th>
                                                <th><?php echo $enreg['cin_cli']?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>Nationalité</td>
                                                <td><?php echo $enreg['nationalite_cli']?></td>
                                            </tr>
                                        </tbody>
										<thead>
                                            <tr>
                                                <th>Permis de conduite N°</th>
                                                <th><?php echo $enreg['num_permis_cli']?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>Délivrée le </td>
                                                <td><?php echo $enreg['delivre_cli']?></td>
                                            </tr>
                                        </tbody>
										<thead>
                                            <tr>
                                                <th>Passport N°</th>
                                                <th><?php echo $enreg['passport_cli']?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>Adresse à l'Etranger</td>
                                                <td><?php echo $enreg['adresse_etr_cli']?></td>
                                            </tr>
                                        </tbody>
										<thead>
                                            <tr>
                                                <th>Téléphone</th>
                                                <th><?php echo $enreg['tel_cli']?></th>
                                            </tr>
                                        </thead>
				...
				?>
                    <div class="text-right">
										<a href="consu_client.php" class="btn btn-rounded btn-dark btn-block"  >Retour</a>
