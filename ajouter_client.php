...
include "config.php";
	...
	$sql = "INSERT INTO client(nom_rais_cli,adresse_cli,email_cli,profession_cli,cin_cli,nationalite_cli,num_permis_cli,delivre_cli,passport_cli,adresse_etr_cli,tel_cli) 
	VALUES('$nom_rais_cli','$adresse_cli','$email_cli','$profession_cli','$cin_cli','$nationalite_cli','$num_permis_cli','$delivre_cli','$passport_cli','$adresse_etr_cli','$tel_cli')";
	$requete = mysql_query($sql) or die( mysql_error() ) ;
 
  if($requete)
  {
    
	echo '<script type="text/javascript">alert("Vous avez bien ajouter le client");</script>';
	echo '<script type="text/javascript">window.location.href="consu_client.php";</script>';
    ...
    <div id="main">
        ...
        <section id="content_wrapper">
            ...
            <section id="content">
				...
				<h4 class="lh30 mt15 text-center">Lcataire</b></h4>
                <div class="row">
                            ...
                            <div class="panel">
                                ...
                                <form method="post" action="" id="admin-form">
                                    <div class="panel-body">
                                        ...
                                        <div class="section">
                                                <label for="firstname" class="field prepend-icon">
                                                    <input type="text" name="nom_rais_cli" id="firstname" class="gui-input" placeholder="Nom et Prénom ou Raison social">
										...
										<div class="section">
                                            <label for="useremail" class="field prepend-icon">
                                                <input type="text" name="adresse_cli" id="useremail" class="gui-input" placeholder="Adresse">
										...
										<div class="section">
                                            <label for="useremail" class="field prepend-icon">
                                                <input type="email" name="email_cli" id="useremail" class="gui-input" placeholder="Email ">
                                        ...
                                        <div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="text" name="profession_cli" id="website" class="gui-input" placeholder="Profession">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="text" name="cin_cli" id="website" class="gui-input" placeholder="CIN N°">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="texte" name="nationalite_cli" id="website" class="gui-input" placeholder="Nationalité">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="texte" name="num_permis_cli" id="website" class="gui-input" placeholder="Permis de conduite N°">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="date" name="delivre_cli" id="website" class="gui-input" placeholder="Délivrée le ">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="texte" name="passport_cli" id="website" class="gui-input" placeholder="Passport N°">
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="texte" name="adresse_etr_cli" id="website" class="gui-input" placeholder="Adresse à l'Etranger">
                                                <label for="website" class="field-icon"><i class="fa fa-email"></i></label>  
                                            </label>
                                        </div><!-- end section --> 
										...
										<div class="section">
                                            <label for="website" class="field prepend-icon">
                                                <input type="texte" name="tel_cli" id="website" class="gui-input" placeholder="Téléphone">
                                                <label for="website" class="field-icon"><i class="fa fa-email"></i></label>  
                                            </label>
                                        </div><!-- end section -->                    
                                    ...
                                    <div class="panel-footer text-right">
                                        <button type="submit" class="button btn-primary"> Ajouter client </button>
