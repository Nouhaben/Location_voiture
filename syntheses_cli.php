                   ...
                   <!-- Column Graph -->
                           <div class="panel panel-info panel-border top">
                            <div class="panel-heading">
                                    <span class="panel-title fw700"> Informations sur les clients</span>
                                </div>
                                    ...
                                    <div class="row table-layout">
                                            ...
                                            <table class="table mbn tc-med-1 tc-bold-last">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <span class="fa fa-circle text-warning fs14 mr10"></span>clients inscrits aujourd'hui :</td>
                                                        <td><?php
													...
													if(isset($client_inscrits[date('Y-m-d')])){
													 ...
													 echo "Aucun client n'est ajouté aujourd'hui."; 
													 }
													?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <span class="fa fa-circle text-info fs14 mr10"></span>clients inscrits cette semaine :</td>
                                                        <td><?php
														$client_inscrits = array_count_values($enr['date_ajout']);
														 ...
														 if($nombretotal == 0 ) {
															echo "Aucun client n'est ajouté cette semaine.";
														 }else {
															echo $nombretotal;
														 }
														  ?></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span class="fa fa-circle text-primary fs14 mr10"></span>clients inscrits ce mois :</td>
                                                        <td><?php
													...
													if(isset($client_inscrits[date('Y-m')])){
													 ...
													 echo "Aucun client n'est ajouté ce mois."; 
													 }
													?></td>
                                                    </tr>
